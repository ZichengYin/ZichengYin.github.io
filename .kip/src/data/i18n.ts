...
export const text = {
  ...
  zh: {
    ...
    galleryIntro:
      '虽然并非美术专业出身，但绘画是我长久以来思考和表达的方式。这里收录了一些原创作品与同人创作。我的技法仍在持续成长，其中部分作品发表在平台上获得了互动量超过 20000。我也参与过三次公共艺术展，为三个非个人项目负责 UI 设计与制作。过去的多次平台约稿交易中，也证明了它们与观众之间的连接。',
  },
} as const
...
export const localizedInternships: Record<Language, LocalizedTextItem[]> = {
  ...
  zh: [
    {
      title: '2026.02 - 2026.04 | 上海智多互娱技术有限公司 | 声音设计',
      body: '担任公司唯一音频岗位，统筹总部与分公司全部项目的声音设计，利用ai等工具生产制作音乐音效。独立完成音频编辑与公司音效库搭建，全面提升团队音频素材调用效率。',
    },
    {
      title: '2025.08 - 2025.10 | 腾讯科技（深圳）有限公司 | 音频支持实习生',
      body: '为《终极角逐》等游戏项目提供音频技术支持与音效设计、测试，使用 TTS 进行语音素材生产与调试。配合团队完成音频资源标准化整理，参与项目音频问题排查，提高团队素材调用效率。',
    },
    {
      title: '2025.07 - 2025.08 | 上海领视信息科技有限公司 | 音乐教研实习生',
      body: '参与音乐类线上课程研发与 UI 设计制作，结合音频技术设计制作了 5 系列互动式音乐课程。进行扒谱打谱工作，配合团队制作课程配套的 30 余份曲谱。',
    },
    {
      title: '2024.07 - 2024.08 | 上海广播电视台东方广播中心 | 助理',
      body: '协助完成经典 947 广播节目制作，负责前期文案撰写、音频素材剪辑与后期处理。配合直播团队完成音乐直播音频筹备，保障直播音频信号稳定，零音频事故。',
    },
    {
      title: '2024.02 - 2024.03 | 上海音乐厅 | 运营',
      body: '全程参与两场“数字缪斯”商业演出的组织工作，负责文档整理、宣传与现场协调。',
    },
  ],
}
...
export const localizedExperience: Record<Language, LocalizedTextItem[]> = {
  ...
  zh: [
    ...
    { title: '2024 上海国际乐器展', body: '在 2024 上海国际乐器展中展出并介绍作品《虚拟云锣》，吸引了众多观众关注与体验。' },
    ...
    { title: '音乐表演', body: 'Banbanband 与 Echo 乐队吉他手，参与商业演出与乐队活动，包括昆山市民文化节乐队专场音乐会。上海音乐学院音乐工程系合唱团团长。' },
...
export const localizedHonors: Record<Language, string[]> = {
  ...
  zh: [
    ...
    '国家版权局 - 计算机软件著作权登记。',
    '作品入选“未来·观 - 中英青年数字创意展”，于 2024 年在伦敦 Royal Mint Court 展出。',
    ...
    '更早：获上海国际青少年科技博览会一等奖等 13 个科技奖项，新美杯国际青少年美术大赛三等奖等 10 个绘画与摄影奖项，在写作方面获得 5 个奖项，古筝十级等 3 项乐器/体育类证书奖项。',
  ],
}
