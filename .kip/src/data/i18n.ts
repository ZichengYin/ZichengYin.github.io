  ...
  zh: [
    {
      ...
      body: '担任公司唯一音频岗位，统筹总部与分公司全部项目的音效与音乐设计制作。独立完成音频编辑与公司音效库搭建，全面提升团队音频素材调用效率。',
    },
    {
      title: '2025.08 - 2025.10 | 腾讯科技（深圳）有限公司 | 音频支持实习生',
      body: '为《终极角逐》提供音频技术支持与音效设计测试，使用 TTS 进行语音素材生产与调试。配合团队完成音频资源标准化整理，参与项目音频问题排查，提高团队素材调用效率。',
    },
    {
